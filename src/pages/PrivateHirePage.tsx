    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-xs sm:text-sm text-[#DFBE7B]/80 leading-relaxed font-sans">
          From candlelit wine vault alcoves for 14 guests to full basement buyouts for up to 60, host your private celebration or corporate evening at 23 SOHO in Frith Street's iconic subterranean cellar.
        </p>
      </div>
      ...
      <div className="relative rounded-2xl overflow-hidden border border-[#C5A059]/40 shadow-2xl aspect-[21/9]">
        <img
          src={PRIVATE_IMAGE}
          alt="Private hire lounge setup at 23 SOHO Frith Street"
          className="w-full h-full object-cover filter brightness-[0.7]"
          referrerPolicy="no-referrer"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#0B0B0C] via-transparent to-transparent opacity-80" />
        <div className="absolute bottom-6 left-6 right-6 p-4 sm:p-6 bg-[#121215]/90 border border-[#C5A059]/40 backdrop-blur-md rounded-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <span className="text-[10px] font-display text-[#DFBE7B] uppercase tracking-wider block">23 SOHO Subterranean Buyout</span>
          ...
          <span className="text-xs font-display text-[#DFBE7B] bg-[#1A1A22] px-3 py-1.5 rounded border border-[#C5A059]/30">
      ...
      <div className="space-y-6">
        <div className="text-center space-y-2">
          <span className="text-[#DFBE7B] text-xs font-display uppercase tracking-widest">Tailored Spaces</span>
            ...
            return (
              <div
                ...
                className={`cursor-pointer rounded-xl p-6 transition-all duration-300 flex flex-col justify-between border ${
                  isSelected
                    ? 'bg-[#181820] border-[#C5A059] shadow-2xl ring-1 ring-[#C5A059]'
                    : 'bg-[#121215] border-[#C5A059]/30 hover:border-[#C5A059]/60'
                }`}
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    {isSelected && (
                      <span className="px-2 py-0.5 text-[10px] bg-[#C5A059] text-[#0B0B0C] font-bold rounded font-display tracking-wider">
                        SELECTED
                      </span>
                    )}
                  </div>
                  ...
                  <div className="p-2.5 bg-[#1A1A22] rounded border border-[#C5A059]/20 text-xs text-[#FFEAA7] font-display font-semibold">
                    {pkg.minimumSpend}
                  </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 bg-[#121215] border border-[#C5A059]/40 rounded-2xl p-6 sm:p-10 shadow-2xl">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="space-y-4 text-xs font-sans">
            ...
            <div className="space-y-2 pt-2">
              ...
              {[
                { id: 'spritz-welcome', name: 'Welcome 23 Soho Cocktail Round (£12 / guest)' },
                ...
                <label
                  ...
                  className={`flex items-center gap-3 p-3 rounded border cursor-pointer transition-colors ${
                    selectedAddons.includes(addon.id)
                      ? 'bg-[#1C1C26] border-[#C5A059] text-[#DFBE7B]'
                      : 'bg-[#181820] border-[#C5A059]/20 text-[#FDFBF7]/70'
                  }`}
                >
                  <input
                    type="checkbox"
            ...
            <div className="p-5 bg-[#181820] border border-[#C5A059] rounded-lg space-y-2">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          {formSubmitted ? (
            <div className="p-8 bg-[#181820] border border-[#C5A059] rounded-xl text-center space-y-4">
              ...
              <p className="text-xs text-[#FDFBF7]/80 max-w-md mx-auto leading-relaxed font-sans">
                Our 23 SOHO Events Director will review your date ({formData.eventDate || 'Requested Date'}) and respond within 24 hours with space confirmation and bespoke menus.
              </p>
              <button
                onClick={() => setFormSubmitted(false)}
                className="btn-brass px-6 py-2.5 text-xs tracking-wider rounded"
              >
